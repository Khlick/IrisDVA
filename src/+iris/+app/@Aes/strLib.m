  ...
  switch stringID
    ...
    case 'keyboardHTML'
      str = [ ...
            ...
            '<p><kbd>PgUp</kbd>, <kbd>PgDn</kbd>: Navigate within selection.</p>\n', ...
            '<p><kbd>Shift</kbd> + <kbd>PgUp, PgDn</kbd>: Navigate selection by small step.</p>\n', ...
    ...
    case 'analyze:selectAnalysis'
      str = 'Select analysis function from the user Iris folder (See View>Preferences>Workspace).';
    case 'analyze:datumInput'
      str = ...
        'Enter data indices to analyze (interpreted as a MATLAB expression).' ...
        ;
    case 'analyze:checkboxSendToCmd'
      str = 'Send the analysis results to the MATLAB workspace.';
    case 'analyze:checkboxAppend'
      str = [ ...
            'Append this result to any existing data in the specified ', ...
            'output file.' ...
          ];
    case 'analyze:editAnalysisTooltip'
      str = 'Open current analysis in the editor.';
    case 'analyze:refreshAnalysisTooltip'
      str = 'Refresh analysis list (reloads defaults).';
    case 'analyze:updateAnalysisTooltip'
      str = 'Set the current values as new defaults.';
    case 'analyze:toggleBatchTooltip'
      str = 'Toggle batch processing options (Not Available).';
    case 'analyze:createAnalysis'
      str = 'Create a new analysis function for analyzing data.';
    case 'analyze:toggleOutputArguments'
      str = 'Show/Hide the output arguments table.';
    case 'analyze:toggleInputArguments'
      str = 'Show/Hide the input arguments table.';
    case 'analyze:backtrackDataIndices'
      str = 'Toggle 2-way synchronization of data indices.';
    case 'analyze:selectDirectory'
      str = 'Select an output file.';
    case 'analyze:performAnalysis'
      str = 'Perform current analysis.';
    case 'analyze:resetDefaults'
      str = 'Reset analysis defaults.';
    case 'analyze:appendAsk'
      str = 'Ask whether to append if the chosen file exists.';
    otherwise
