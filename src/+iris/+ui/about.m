    ...
    function startupFcn(obj,varargin)
      ...
      while true
        ...
        try
          ...
          obj.window.executeJS( ...
            sprintf([ ...
            '[logoPanel] = dojo.query("[%s = ''%s'']").slice(-1);', ...
            'logoPanel.replaceChild(logo,logoPanel.firstChild);' ...
            ], ...
          ...
          obj.window.executeJS( ...
            sprintf([ ...
            '[contentsPanel] = dojo.query("[%s = ''%s'']").slice(-1);', ...
            'contentsPanel.replaceChild(contents,contentsPanel.firstChild);' ...
            ], ...
            id.ID_attr, id.ID_val ...
            ) ...
            );
