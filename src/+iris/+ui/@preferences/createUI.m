...
obj.OutputDirectoryLabel.Position = [23 268 129 22];
...
obj.OutputDirectoryInput.Position = [58 234 335 22];

% Create OutputLocatoinButton
obj.OutputLocatoinButton = uibutton(obj.WorkspacePanel, 'push');
obj.OutputLocatoinButton.ButtonPushedFcn = @(s,e)obj.updateDirectory(s,eventData('Output'));
obj.OutputLocatoinButton.Icon = fullfile(iris.app.Info.getResourcePath, 'icn', 'icons8-folder-128.png');
obj.OutputLocatoinButton.VerticalAlignment = 'bottom';
obj.OutputLocatoinButton.BackgroundColor = [0.9412 0.9412 0.9412];
obj.OutputLocatoinButton.FontName = Aes.uiFontName;
obj.OutputLocatoinButton.FontSize = 14;
obj.OutputLocatoinButton.Position = [23 233 26 25];
obj.OutputLocatoinButton.Text = '';
...
obj.AnalysisDirectoryButton.Position = [23 152 26 25];
...
obj.AnalysisDirectoryLabel.Position = [23 187 208 22];
...
obj.AnalysisDirectoryInput.Position = [58 153 335 22];
...
obj.AnalysisPrefixLabel.FontSize = 18;
obj.AnalysisPrefixLabel.Position = [23 106 176 22];
obj.AnalysisPrefixLabel.Text = 'Analysis Output Prefix:';
...
obj.AnalysisPrefixInput.Position = [23 72 370 22];
...
obj.AnalysisPrefixPreviewLabel.Position = [23 47 176 22];
...
obj.AnalysisPrefixPreviewString.FontSize = 16;
...
obj.FilterOrderSelect.ValueChangedFcn = @(s,e)notify(obj,'FilterChanged', eventData('FilterOrder'));
...
obj.FilterFrequencyLowSelect.ValueChangedFcn = @(s,e)notify(obj,'FilterChanged', eventData('FilterFrequency'));
...
obj.FilterFrequencyHighSelect.ValueChangedFcn = @(s,e)notify(obj,'FilterChanged', eventData('FilterFrequency'));
...
obj.FilterTypeSelect.ValueChangedFcn = @(s,e)notify(obj,'FilterChanged', eventData('FilterType'));
...
obj.GroupBySelect.ValueChangedFcn = @(s,e)notify(obj,'StatisticsChanged', eventData({'GroupBy',s.Value}));
...
obj.AggregationStatisticSelect.ValueChangedFcn = @(s,e)notify(obj,'StatisticsChanged', eventData({'AggregationStatistic',s.Value}));
...
obj.ShowAll.ValueChangedFcn = @(s,e)notify(obj,'StatisticsChanged', eventData({'ShowAll',s.Value}));
...
obj.ZeroBaseline.ValueChangedFcn = @(s,e)notify(obj,'StatisticsChanged', eventData({'ZeroBaseline',s.Value}));
...
obj.BaselineRegionSelect.ValueChangedFcn = @(s,e)notify(obj,'StatisticsChanged', eventData({'BaselineRegion', s.Value}));
...
obj.BaselinePoints.ValueChangedFcn = @(s,e)notify(obj,'StatisticsChanged', eventData({'BaselinePoints',s.Value}));
...
obj.ScaleMethodSelect.ValueChangedFcn = @(s,e)obj.ScaleMethodChanged(s,eventData(s.Value));
...
obj.ScaleValue.ValueChangedFcn = @(s,e)notify(obj,'ScalingChange', eventData('ScaleValue'));
...
obj.LineStyle.ValueChangedFcn = @(s,e)notify(obj,'DisplayChanged', eventData({'LineStyle',s.Value}));
...
obj.MarkerStyle.ValueChangedFcn = @(s,e)notify(obj,'DisplayChanged', eventData({'MarkerStyle',s.Value}));
...
obj.Grid.ValueChangedFcn = @(s,e)notify(obj,'DisplayChanged', eventData({'Grid', s.Value}));
...
obj.AxesScaleX.ValueChangedFcn = @(s,e)notify(obj,'DisplayChanged', eventData({'AxesScaleX',s.Value}));
...
obj.AxesScaleY.ValueChangedFcn = @(s,e)notify(obj,'DisplayChanged', eventData({'AxesScaleY',s.Value}));
