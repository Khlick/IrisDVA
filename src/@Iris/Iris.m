classdef Iris < iris.app.Container
  ...
  %   Written By Khris Griffis, for Sampath lab 2016-2022
  ...
  methods (Access = protected)
    ...
    function saveSession(app, ~, ~)
      ...
      app.loadShow.update('Saving Session...');
      ...
      try
        ...
        app.loadShow.update('<span class="red">Error!</span>');
        pause(1.5);
        app.loadShow.shutdown();
        app.ui.focus();
